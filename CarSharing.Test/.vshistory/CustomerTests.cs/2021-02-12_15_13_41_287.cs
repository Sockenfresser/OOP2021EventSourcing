...
namespace CarSharing.Test
{
    public class CustomerTests
    {
        ...
        public void ChangeCustomersName_CustomerRegistered_NameChangedEventReturned()
        {
            ...
            var customerNameChanged = (CustomerNameChanged)resultEvent;
            Assert.Equal(_customerId.Value, customerNameChanged.CustomerId.Value);
            Assert.Equal(newGivenName, customerNameChanged.NewName.GivenName);
            Assert.Equal(newFamilyName, customerNameChanged.NewName.FamilyName);
            Assert.Equal(newGivenName, customer.PersonName.GivenName);
            Assert.Equal(newFamilyName, customer.PersonName.FamilyName);
        }
