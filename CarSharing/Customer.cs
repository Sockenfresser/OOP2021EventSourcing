...
namespace CarSharing
{
    public class Customer
    {
            ...
            foreach (var @event in events)
            {
                switch (@event)
                {
                    ...
                    case CustomerEmailAddressConfirmed _:
                        ...
                        break;
                    case CustomerEmailAddressChanged addressChanged:
                        result.EmailAddress = addressChanged.EmailAddress;
                        result.Hash = addressChanged.ConfirmationHash;
                        result.IsEmailAddressConfirmed = false;
                        break;
                    case CustomerNameChanged nameChanged:
                        result.PersonName = nameChanged.NewName;
                        break;
                }
            }
        ...
        {
            if (EmailAddress.Value == changeCustomerEmailAddress.EmailAddress.Value)
            {
                return null;
            }
